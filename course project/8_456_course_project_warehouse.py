...
2. Найти технику на складе по номеру модели(например, laserJet1)
3. Количество техники на складе в наличии по типу(принтеров: 2 штуки)
4. Показать, вывести весь список техники на складе
5.Удалить технику со склада по модели(например, laserJet1)
6.Сохранить в файл список техники со склада
